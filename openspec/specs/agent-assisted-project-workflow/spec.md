# agent-assisted-project-workflow Specification

## Purpose
Define the safe daily workflow for agent-assisted planning, implementation, validation, security review, and GitHub handoff across PAHLAWAN ROLEPLAY.
