# ucp-local-smoke-runbook Specification

## Purpose
Define the practical local UCP smoke validation runbook for repo development, production-build validation, and flattened XAMPP runtime checks without exposing secrets or writing database/runtime state.
