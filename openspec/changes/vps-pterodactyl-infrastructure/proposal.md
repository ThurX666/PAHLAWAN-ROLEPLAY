...
- Definisikan 3 custom Pterodactyl eggs: SA-MP/open.mp server, UCP website (Nginx + PHP-FPM), Discord bot (Node.js).
- Definisikan shared MySQL setup yang bisa diakses semua service.
- Definisikan environment variable management per service.
- Definisikan deployment flow: dari git clone di VPS sampai service jalan dan bisa di-kontrol dari Pterodactyl UI.
...
- **Infrastructure**: Menambah dokumentasi dan script setup untuk VPS dan Pterodactyl.
